...
export default function Header() {
	...
	return (
		<div className="bg-white h-16 px-4 flex items-center border-b border-gray-200 justify-end">
			<div className=' mr-96 text-2xl font-bold'>Dashboard</div>
			<div className="relative">
				<HiOutlineSearch fontSize={20} className="text-gray-400 absolute top-1/2 left-3 -translate-y-1/2" />
				<input
					type="text"
					placeholder="Search..."
					className="text-sm focus:outline-none active:outline-none border  w-[18rem] h-10 pl-11 pr-4 shadow-md rounded-xl bg-white"
				/>
			</div>
